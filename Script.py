...
• ᴜꜱᴇʀɴᴀᴍᴇ : <a href=https://t.me/Sachin_official_admin>ꜱᴀᴄʜɪɴ ꜱ</a></b>"""
    ...
    KANNADASPELL_TXT = "<i><b>ಹಲೋ ನೀವು ವಿನಂತಿಸಿದ ಈ ಚಲನಚಿತ್ರವನ್ನು ನಾನು ಹುಡುಕಲಾಗಲಿಲ್ಲ 🥴 ...\n\nGoogle,Yandex ನಲ್ಲಿ ಯಾವುದೇ ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡಿ ಮತ್ತು ಸರಿಯಾದ ಚಲನಚಿತ್ರದ ಹೆಸರನ್ನು ಹುಡುಕಿ ಮತ್ತು ಅದನ್ನು ಇಲ್ಲಿ ನಮೂದಿಸಿ ಮತ್ತು ನೀವು ಚಲನಚಿತ್ರ / ಧಾರಾವಾಹಿಯನ್ನು ಪಡೆಯುತ್ತೀರಿ 🙂...\n\nಒಂದು ವೇಳೆ ನೀವು ಸರಿಯಾದ ಹೆಸರನ್ನು ನಮೂದಿಸಿ ಆದರೆ ನೀವು ಚಲನಚಿತ್ರವನ್ನು ಪಡೆಯಲಿಲ್ಲ ... </b> <code>@admin query</code> <b>ಈ ಸ್ವರೂಪದಲ್ಲಿ ನಿರ್ವಾಹಕರಿಗೆ ತಿಳಿಸಿ .. ನಾವು 24 ಗಂಟೆಗಳ ಒಳಗೆ ಅಪ್‌ಲೋಡ್ ಮಾಡುತ್ತೇವೆ 😇</b></i>"
...
<code>/batch https://t.me/KR_OTT_OFFICIAL/14 https://t.me/KR_OTT_OFFICIAL/14</code>
"""
    ABOUT_TXT = """
○ 𝖬𝗒 𝖭𝖺𝗆e : ᴘʀᴀʙʜᴀꜱ
